...
//	    try {
		...
		String resetPasswordLink = "http://localhost:4200" + "/account/reset_password?token=" + token;
...
//	    }
	...
	public LinkedHashMap<String, Object> userQuery(@PathVariable String emailid, @PathVariable String message,
		...
		LinkedHashMap<String, Object> response = new LinkedHashMap<String, Object>();
		String finalMessage = "Hello my name is " + Name + " My email: " + emailid + " " + "my Subject is " + Subject
				+ " " + "I have the following query " + message;
		mailService.send("spares365.stigentech@gmail.com", "spares365.stigentech@gmail.com", "user query ",
				finalMessage);
		response.put("Status ", 1);
	...
	public String processPlaceOrder() throws UnsupportedEncodingException, MessagingException {
		String email = "uber.ayodhya@gmail.com";
		System.out.println(email);
	...
	public void sendPlaceOrderMail(String recipientEmail) throws MessagingException, UnsupportedEncodingException {
		...
		String content = "Text from Spare365";
		helper.setSubject(subject);
